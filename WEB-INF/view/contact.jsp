			...
			<div class="row">
				...
				<div class="col-sm-6">
					...
					<p class="contact-us-details">
						...
						<b>Email:</b> <a href="mailto:getintoutch@yourcompanydomain.com">Royalinteriors@gmail.com</a>
					</p>
					<!-- End Contact Info -->
				</div>
				...
				<div class="col-footer col-md-4 col-xs-6">
					...
					<p class="contact-us-details">
						...
						+1 123 45678910<br /> <b>Email:</b> <a
							href="mailto:info@yourcompanydomain.com">info@yourcompanydomain.com</a>
					</p>
				</div>
				<div class="col-footer col-md-4 col-xs-6">
					...
					<div>
						...
						<img src="img/icons/twitter.png" width="32" alt="Twitter"> <img
							src="img/icons/linkedin.png" width="32" alt="LinkedIn"> <img
							src="img/icons/rss.png" width="32" alt="RSS Feed">
					</div>
				</div>
				<div class="col-footer col-md-4 col-xs-6">
					<h3>About Our Company</h3>
					<p>We have accomplished many task successfully</p>
				</div>
